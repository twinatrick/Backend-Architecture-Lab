...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, String> alarmProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, String> alarmKafkaTemplate(ProducerFactory<String, String> alarmProducerFactory) {
