 ...
 * 內嵌 Toxiproxy 代理通道，兼具全域共用高效率與確定性混沌故障注入能力
 */
public final class SharedContainers {
    ...
    static {
        ...
        REDIS_CONTAINER = new GenericContainer<>(DockerImageName.parse("redis:7.2-alpine"))
                .withNetwork(NETWORK)
                .withNetworkAliases("shared-redis")
        ...
        log.info("SharedContainers 初始化完成: PostgresProxy={}:{}, RedisProxy={}:{}",
    ...
    public static String getPostgresUrlForDatabase(String databaseName) {
        return String.format(
                "jdbc:postgresql://%s:%d/%s?connectTimeout=5&socketTimeout=5",
    ...
    public static String getDirectRedisHost() {
        return REDIS_CONTAINER.getHost();
    }

    public static Integer getDirectRedisPort() {
