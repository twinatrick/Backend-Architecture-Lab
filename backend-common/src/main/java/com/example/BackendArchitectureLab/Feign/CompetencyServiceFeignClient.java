...
import com.example.BackendArchitectureLab.Config.CompetencyServiceFeignConfiguration;
 ...
 */
@FeignClient(name = "competency-service", configuration = CompetencyServiceFeignConfiguration.class)
