-- ============================================================================
-- 壓力測試基礎資料
-- 角色 (Role)、功能權限 (Function)、技能 (Skill)、技能等級 (SkillLevel)
-- 包含固定 UUID 以便跨腳本參考
-- ============================================================================
...
-- ============================================================================
-- 2. 技能（100 項，涵蓋半導體、軟體、AI、管理等領域）
--    注意：Function 由 InitAndCheckService 在啟動時建立，此處不 INSERT
-- ============================================================================
