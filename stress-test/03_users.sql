-- ============================================================================
-- 壓力測試使用者資料 (50,000 筆)
-- 密碼 BCrypt hash ({bcrypt}$2a$10$G/9HqlIZuvJcEHUpcLiYW.1zlkrEtBrXBbx0or4.89GcHZe2egA9a)
-- 對應明文: password
...
VALUES
('00000000-0000-0000-0000-000000000001', 'Admin', 'admin@tsmc.com', '{bcrypt}$2a$10$G/9HqlIZuvJcEHUpcLiYW.1zlkrEtBrXBbx0or4.89GcHZe2egA9a', '0910000000', false, 'stress-test', 'stress-test', NOW(), NOW()),
('00000000-0000-0000-0000-000000000002', 'HR_Manager', 'hr@tsmc.com', '{bcrypt}$2a$10$G/9HqlIZuvJcEHUpcLiYW.1zlkrEtBrXBbx0or4.89GcHZe2egA9a', '0910000001', false, 'stress-test', 'stress-test', NOW(), NOW()),
('00000000-0000-0000-0000-000000000003', 'Engineer_Lead', 'engineer@tsmc.com', '{bcrypt}$2a$10$G/9HqlIZuvJcEHUpcLiYW.1zlkrEtBrXBbx0or4.89GcHZe2egA9a', '0910000002', false, 'stress-test', 'stress-test', NOW(), NOW())
...
SELECT
  ...
  '{bcrypt}$2a$10$G/9HqlIZuvJcEHUpcLiYW.1zlkrEtBrXBbx0or4.89GcHZe2egA9a',
