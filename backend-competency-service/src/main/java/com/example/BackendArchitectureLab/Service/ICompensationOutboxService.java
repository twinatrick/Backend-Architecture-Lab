...
public interface ICompensationOutboxService {
    ...
    /**
     * 業務交易失敗後補發補償請求事件（獨立新交易，含錯誤訊息）。
     * 閉環：Consumer 僅對 COMPENSATION_REQUIRED 事件委派 CompensationStrategy 執行補償。
     */
    void enqueueCompensationRequired(UUID transactionId, CompensationAction action,
