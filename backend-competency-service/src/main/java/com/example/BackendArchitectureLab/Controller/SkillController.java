...
public class SkillController {
    ...
    @GetMapping("/get")
    @RequirePermission({"System", "Skill", "View"})
    ...
    @RequirePermission({"System", "SkillLevel", "Edit"})
    ...
    @RequirePermission({"System", "SkillLevel", "View"})
    ...
    @RequirePermission({"System", "PersonalSkill", "Edit"})
