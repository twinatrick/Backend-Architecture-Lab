...
class UserProjectSkillDataAccessImplTest {
    ...
    private final IUserProjectSkillDataAccess dataAccess;
    ...
    @Autowired
    public UserProjectSkillDataAccessImplTest(UserProjectSkillRepository repository,
        ...
        this.dataAccess = new UserProjectSkillDataAccessImpl(repository);
    }
    ...
    void testFindByUserId() {
        ...
        List<UserProjectSkill> result = dataAccess.findByUserId(testUserId);
    ...
    void testFindByUserIdAndProjectIdAndSkillId() {
        ...
        Optional<UserProjectSkill> result = dataAccess.findByUserIdAndProjectIdAndSkillId(
                testUserId, testProject.getId(), testSkill.getId());
    ...
    void testExistsByUserIdAndProjectId() {
        ...
        assertTrue(dataAccess.existsByUserIdAndProjectId(testUserId, testProject.getId()));
    ...
    void testDeleteByUserIdAndProjectId() {
        ...
        dataAccess.deleteByUserIdAndProjectId(testUserId, testProject.getId());
